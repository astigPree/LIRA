...
Voice Command Features;
    ...
    Emergency Response: Activate the full emergency response with certain voice commands:
        ...
        Alarm, Lights, GPS & Help Request: Trigger alarm, illuminate the device, and send help request.
...
Panic Button Features
    Multi-Function Activation: Scenario:
...
Voice Command Features
    Customizable Commands: Scenario:
